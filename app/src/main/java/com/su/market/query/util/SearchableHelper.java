...
import com.su.market.query.Searchable;
...
public class SearchableHelper {
    ...
    public void refreshFilterColor(@NonNull TextView textView, int position, @Nullable List<Map<Integer, Integer>> filterColorIndexList) {
        if (filterColorIndexList == null || filterColorIndexList.isEmpty()) {
            return;
        }
    ...
    public boolean find(@NonNull String filter, @Nullable String source, @Nullable List<Map<Integer, Integer>> filterColorIndexList) {
        if (source == null) {
            source = "";
        }
    ...
    public void initSearchToolbar(@NonNull Toolbar toolbar, @NonNull SearchView.OnQueryTextListener listener) {
        ...
        initSearchToolbar(toolbar, context.getString(R.string.input_keyword), listener);
    }
    ...
    public void initSearchToolbar(@NonNull Toolbar toolbar, @Nullable String queryHint, @NonNull SearchView.OnQueryTextListener listener) {
        ...
        mSearchView.findViewById(androidx.appcompat.R.id.search_plate).setBackgroundResource(android.R.color.transparent);
